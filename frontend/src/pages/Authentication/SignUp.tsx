...
import { useRegisterMutation } from '../../redux/slices/studentSlice';
import { useMregisterMutation } from '../../redux/slices/mentorSlice';
...
const SignUp: React.FC = () => {
  ...
  const [mregister] = useMregisterMutation();
  ...
  const submitHandler = async (e: any) => {
    ...
    if (role == 'student') {
      ...
      const res = await mregister({ ...userobj }).unwrap();
      console.log(res);
    }
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="  xl:w-1/2">
            <div className="absolute top-20 py-10 px-26 text-center flex flex-col justify-center">
              <Link className=" flex flex-col justify-center" to="/">
                <img
                  className="dark:hidden  h-15 w-15 ml-60"
                  src={Logo}
                  alt="Logo"
                />
                <span className="ml-20 pt-10 text-xl underline">ProjectQ</span>
              </Link>

              <span className="mt-10 ml-28 inline-block">
                <svg
                  width="350"
                  height="350"
                  viewBox="0 0 350 350"
