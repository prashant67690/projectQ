...
import { useLoginMutation } from '../../redux/slices/studentSlice';
import { useMloginMutation } from '../../redux/slices/mentorSlice';
...
const SignIn: React.FC = () => {
  ...
  const [mlogin] = useMloginMutation();
  ...
  const submitHandler = async (e: any) => {
    ...
    try {
      if (role == 'student') {
        ...
        const res = await mlogin({ email, password }).unwrap();
        console.log(res);

        dispatch(setCredentialsMentor({ ...res }));
        toast.success('Logged In');
        navigate('/home');
      }
    } catch (e) {
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <Link className="inline-block" to="/">
              <img
                className="hidden h-13 w-12 dark:block"
                src={Logo}
                alt="Logo"
              />
              <img
                className="dark:hidden m-10 h-15 w-15 "
                src={Logo}
                alt="Logo"
              />
              <span className="pt-10 py-2 text-xl underline">ProjectQ</span>
            </Link>
