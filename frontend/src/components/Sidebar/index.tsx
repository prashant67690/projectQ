...
const Sidebar = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:3000/api/project/', { credentials: 'include' })
      .then((res) => res.json())
      .then((data) => {
        if (
          data.data.synopsis != null &&
          data.data.joiningReport != null &&
          data.data.completionCertificate != null &&
          data.data.midterm != null &&
          data.data.endterm != null &&
          data.data.endtermreport != null
        ) {
          setCheck(true);
        } else {
          setCheck(false);
  ...
  const { isMentor } = useSelector((state: RootState) => state.auth);
        ...
        <nav className="mt-5  px-4 lg:mt-5 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Calendar --> */}
              {/* <!-- Menu Item Mentor Assign --> */}
              {!isMentor && (
                <li>
                  <NavLink
                    to="/teacherAssistant"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('mentor Form') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
              ...
              {/* <!-- Menu Item Document --> */}
              {/* <!-- Menu PPT AND REPORT Assign --> */}
              {!isMentor && (
                <li>
                  <NavLink
                    to="/gradedocs"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('Graded Documents') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
              ...
              {/* <!-- Menu Item Documnets View For Mentor  --> */}
              {isMentor && (
                <li>
                  <NavLink
                    to="/mentor/documents"
